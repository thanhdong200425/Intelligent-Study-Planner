...
import { Calendar, ListTodo, BarChart2, Clock, LayoutGrid, Timer, ChevronsLeft, BookOpen } from 'lucide-react';
...
const Item: React.FC<MenuItem & { isActive?: boolean }> = ({ icon: Icon, isActive, ...props }) => {
    return (
