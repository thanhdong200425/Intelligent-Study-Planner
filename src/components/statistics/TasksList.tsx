...
export const TasksList: React.FC<TasksListProps> = ({
  ...
  const getTaskTypeColor = (type: TaskType) => {
    switch (type) {
      ...
      case "coding": return "text-green-600 bg-green-50";
      case "writing": return "text-purple-600 bg-purple-50";
      case "pset": return "text-orange-600 bg-orange-50";
                ...
                <tr>
                  ...
                  <td className="px-6 py-4">
                    <select
                      value={editForm.type}
                      onChange={(e) =>
                        setEditForm({ ...editForm, type: e.target.value as TaskType })
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                      {taskTypes.map((type) => (
                  ...
                  <td className="px-6 py-4">
                    <input
                      ...
                      onChange={(e) =>
                        setEditForm({ ...editForm, estimateMinutes: parseInt(e.target.value) || 0 })
                      }
                      min="1"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
