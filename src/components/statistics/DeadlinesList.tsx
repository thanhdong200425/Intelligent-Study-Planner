    ...
    <div className="space-y-4">
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              {deadlines.map((deadline) => (
                <tr key={deadline.id} className={deadline.completed ? "bg-gray-50" : ""}>
                  <td className="px-6 py-4">
                    <input
                      type="checkbox"
                  ...
                  <td className="px-6 py-4">
                    {editingId === deadline.id ? (
                      ...
                      <div className="flex items-center space-x-2">
                        <span className={`text-sm font-medium ${deadline.completed ? "line-through text-gray-500" : "text-gray-900"}`}>
                          {deadline.title}
                        </span>
                  ...
                  <td className="px-6 py-4">
                    {editingId === deadline.id ? (
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`text-sm ${isOverdue(deadline.dueDate) && !deadline.completed ? "text-red-600 font-medium" : "text-gray-600"}`}>
      ...
      {deadlines.length === 0 && !isAdding && courses.length > 0 && (
        <div className="text-center py-8 text-gray-500">
          No deadlines found. Click "Add Deadline" to create your first deadline.
        </div>
      )}
    </div>
  );
