                    ...
                    >
                      ...
                      {hour === 9 && dayIndex === 1 && (
                        <div className="absolute inset-1 bg-blue-100 border border-blue-200 rounded p-1">
                          <div className="text-xs font-medium text-blue-800">Meeting</div>
                        </div>
                      )}
                      {hour === 14 && dayIndex === 2 && (
                        <div className="absolute inset-1 bg-green-100 border border-green-200 rounded p-1">
                          <div className="text-xs font-medium text-green-800">Study</div>
                        </div>
                      )}
                      {hour === 11 && dayIndex === 4 && (
                        <div className="absolute inset-1 bg-purple-100 border border-purple-200 rounded p-1">
                          <div className="text-xs font-medium text-purple-800">Review</div>
                        </div>
                      )}
                    </div>
                  );
